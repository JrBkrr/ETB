<template>
  <div class="row px-10 h-100">
    <div class="col-3 h-100 pe-4 shadow">
      <div class="bg-light-dark rounded overflow-auto h-100">
        <div class="m-2 col">
          <!--begin::Form-->
        ...
        <div class="ps-2">
          <!--begin::List-->
          <template v-for="(item, index) in State.Devices" :key="index">
            <div class="d-flex flex-stack py-4 cursor-pointer" @click="State.TargetLocation = {...item,coordinates: [item.longitude,item.latitude]}">
              <!--begin::Details-->
              <div class="d-flex align-items-center">
                <!--begin::Avatar-->
                <div class="symbol symbol-45px symbol-circle">
                  <span
                      :class="`bg-light-${State.TargetLocation.id === item.id} text-${item.color}`"
                      class="symbol-label fs-6 fw-bold"
                  >
                    {{ item.serialNumber.charAt(0) }}
                  </span>
                  <div
                      v-if="item.online"
    ...
    <div class="col-9 h-100 bg-light-dark rounded p-2 overflow-hidden">
      <Map />
    </div>
  </div>
</template>
...
import Map from "@/components-ekds/custom/Map.vue";
