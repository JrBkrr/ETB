          ...
          <div class="mw-lg-600px mx-auto">
            ...
            <div class="mb-13 text-center">
              ...
              <div class="text-gray-400 fw-semobold fs-5">
                ...
                <a class="link-primary fw-bold">Author Commision</a>.
              </div>
              <!--end::Description-->
            </div>
            <!--end::Heading-->
            ...
            <!--begin::Actions-->
            <div class="d-flex">
              <a class="btn btn-light-primary w-100">
                <img
                    alt="Logo"
              ...
              <a class="btn btn-icon btn-facebook w-100 mx-6">
                <img
                    alt="Logo"
              ...
              <a class="btn btn-icon btn-twitter w-100">
                <img
                    alt="Logo"
