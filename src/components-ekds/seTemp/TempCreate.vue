        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
          ...
          >
            ...
            <div class="d-flex flex-column mb-8 fv-row">
              ...
              <el-form-item prop="hardwareVersions">
                <el-select
                    ...
                    @change="e => targetData.devices = e.map(a => a = {id: a.id})"
                >
            ...
            <div class="d-flex flex-column mb-8 fv-row">
              ...
              <div v-for="(value,idx) in settingValues" class="d-flex align-items-center justify-content-between">
  ...
  setup() {
    ...
    const submit = () => {
      ...
      formRef.value.validate(async (valid: boolean) => {
        await Action_Start('post', 'settings-templates', '', targetData.value).then(async Response => {
          setTimeout(() => {
            loading.value = false;
